...
from streaming.base.shuffle import get_shuffle_med, get_shuffle_slow
...
def parse_args() -> Namespace:
    ...
    args.add_argument('--seed', type=int, default=9186)
    args.add_argument('--epoch', type=int, default=0)
    args.add_argument('--timeout', type=float, default=120)
    args.add_argument('--samples_per_shard', type=float, default=50_000)
...
def main(args: Namespace) -> None:
    ...
    """
    names = 'slow', 'med'
    get_shuffles = get_shuffle_slow, get_shuffle_med
