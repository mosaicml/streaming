...
from joshua.base.util import get_import_exception_message
from joshua.base.util import merge_index as do_merge_index
...
from joshua.base.format.mds.encodings import _encodings
...
def dataframe_to_mds(dataframe: DataFrame,
    ...
    Args:
        ...
        mds_kwargs (dict): Refer to https://docs.mosaicml.com/projects/joshua/en/stable/
            api_reference/generated/joshua.MDSWriter.html
