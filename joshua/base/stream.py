...
from joshua.base.compression import decompress
from joshua.base.constant import TICK
from joshua.base.distributed import barrier, get_local_rank
from joshua.base.format import FileInfo, Reader, get_index_basename, reader_from_json
from joshua.base.hashing import get_hash
from joshua.base.storage import download_file
from joshua.base.util import retry, wait_for_file_to_exist
...
class Stream:
    ...
    * The remaining arguments are optional knobs for controlling downloading behavior and default
    ...
    def _prepare_shard_part(self,
        ...
        MDS format uses joint shards (ie, one file per shard). Other formats supported by joshua
    ...
    def get_shards(self, world: World, allow_unsafe_types: bool) -> list[Reader]:
        ...
        # Version check.
        if obj['version'] != 2:
            raise ValueError(f'Unsupported joshua data version: {obj["version"]}. ' +
