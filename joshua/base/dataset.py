...
"""A mid-epoch-resumable joshua/caching pytorch IterableDataset."""
...
from joshua.base.constant import (BARRIER, BARRIER_FILELOCK, CACHE_FILELOCK, CACHE_USAGE,
                                     EPOCH_DATA, EPOCH_SHAPE, NEXT_EPOCH, RESUME,
                                     SHARD_ACCESS_TIMES, SHARD_STATES, TICK)
from joshua.base.distributed import maybe_init_dist
from joshua.base.format import get_index_basename
from joshua.base.sampling import get_sampling
from joshua.base.shared import (SharedArray, SharedBarrier, SharedMemory, SharedScalar,
...
class StreamingDataset(Array, IterableDataset):
    ...
    * What to iterate:
      ...
      * Knobs to control joshua behavior, which, if multiple streams are provided,
