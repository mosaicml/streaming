...
from joshua.base.constant import SHM_TO_CLEAN
from joshua.base.distributed import get_local_rank, maybe_init_dist
...
def get_import_exception_message(package_name: str, extra_deps: str) -> str:
    ...
    return f'Streaming was installed without {package_name} support. ' + \
            ...
            f'`pip install \'mosaicml-joshua[{package_name}]\'`.'
...
def retry(  # type: ignore
    ...
    Example:
        .. testcode::
            ...
            from joshua.base.util import retry
