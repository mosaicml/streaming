...
from joshua.base.format.base.reader import FileInfo, JointReader
from joshua.base.format.mds.encodings import is_mds_encoding_safe, mds_decode
...
class MDSReader(JointReader):
    ...
    def from_json(cls, dirname: str, split: Optional[str], obj: dict[str, Any]) -> Self:
        ...
        args = deepcopy(obj)
        if args['version'] != 2:
            raise ValueError(f'Unsupported joshua data version: {args["version"]}. ' +
