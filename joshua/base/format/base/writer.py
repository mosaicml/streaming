...
"""Serialize samples into joshua dataset shards and index."""
...
from joshua.base.compression import compress, get_compression_extension, is_compression
from joshua.base.format.index import get_index_basename
from joshua.base.hashing import get_hash, is_hash
...
class JointWriter(Writer):
    """Writes a joshua dataset with joint shards.
...
class SplitWriter(Writer):
    """Writes a joshua dataset with split shards.
