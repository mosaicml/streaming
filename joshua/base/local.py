...
"""A non-joshua pytorch map Dataset."""
...
from joshua.base.format import get_index_basename, reader_from_json
...
class LocalDataset(Array, Dataset):
    """A joshua dataset whose shards reside locally as a pytorch Dataset.
