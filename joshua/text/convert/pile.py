...
"""Pile joshua dataset conversion script."""
...
from joshua.base.util import get_list_arg
...
def each_task(in_root: str, out_root: str, compression: str, hashes: list[str], size_limit: int,
    ...
    """Get the arg tuple corresponding to each JSONL input file to convert to joshua.
...
def main(args: Namespace) -> None:
    """Convert the Pile to joshua format.
