...
from streaming.base.coord.mmap.number import (MemMapFloat16, MemMapFloat32, MemMapFloat64,
                                              MemMapFloating, MemMapInexact, MemMapInt8,
                                              MemMapInt16, MemMapInt32, MemMapInt64, MemMapInteger,
                                              MemMapNumber, MemMapSignedInteger, MemMapUInt8,
                                              MemMapUInt16, MemMapUInt32, MemMapUInt64,
                                              MemMapUnsignedInteger, float16, float32, float64,
