...
class StreamingDataset(Array, IterableDataset):
    ...
    * How to iterate (the StreamingDataset arguments):
    ...
    def __init__(
        ...
        self.job_dir = JobDirectory(self.registry, streams, world)
        ...
        self._shared_barrier = SharedBarrier(self.job_dir.get_filename(BARRIER_FILELOCK),
        ...
        filename = self.job_dir.get_filename(CACHE_FILELOCK)
