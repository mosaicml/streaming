...
def generate_work_random_batching(dataset: StreamingDataset, world: World, epoch: int, sample_in_epoch: int) -> NDArray[np.int64]:
        ...
        big_ids = get_partitions(dataset.partition_algo, dataset.epoch_size, dataset.num_canonical_nodes,
                                 world.num_nodes, world.ranks_per_node, world.workers_per_rank,
                                 dataset.batch_size, sample_in_epoch)
